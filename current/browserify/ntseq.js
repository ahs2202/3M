...
},{}],"ntseq/":[function(require,module,exports){
...
void function nodeExtension(Nt) {

  'use strict';

  var fs = require('fs');

  Nt.Seq.prototype.loadFASTA = function(path) {

    return this.readFASTA(fs.readFileSync(path).toString());

  };

  Nt.Seq.prototype.load4bnt = function(path) {
  ...
  Nt.Seq.prototype.save4bnt = function(name, path) {

    name = name || 'sequence_' + (new Date).valueOf();
